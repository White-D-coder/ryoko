...
export const Hero: React.FC<HeroProps> = ({ onSearch }) => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-between overflow-hidden pt-28 pb-24">
      ...
      <div className="relative z-20 max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-12 w-full flex-1 flex flex-col justify-center pt-4 pb-4">
      ...
      <div className="relative z-5 max-w-7xl mx-auto px-4 sm:px-6 lg:px-2 w-full pb-10">
